...
namespace PowerChart.Bar
{
    ...
    /// </para>
    /// </summary>
    [Cmdlet(VerbsCommon.Add, "Bar")]
    public sealed class AddBarCommand : PSCmdlet
    {
        /// <summary>
        ...
        /// <summary>
        /// Y coordinate for a bar on the chart.
        /// </summary>
        ...
        /// <summary>
        /// <see cref="InputObject"/> property to use as an y coordinate for a bar on the chart.
        /// </summary>
